...
const churchCzLead = `<article class="lead-story"><div class="story-image"><img src="assets/votruba/write-lawmakers.jpg" alt="Černobílá kresba Jiřího Votruby: ruka zapisuje zprávu"><span>Jiří Votruba</span></div><div class="story-copy"><p class="kicker">ZPRÁVA DNE · PASTÝŘSKÉ LISTY · 15. 8. 2026 · REPORT 15082026-012</p><h1><a href="zpravy/15082026-012.html">Desatero pastýřských listů z Evropy u Ospělova</a></h1><p class="standfirst">Deset podání ze dne 15. srpna 2026 s aktivními PDF, soudní termíny ve věci 45 T 1/2024 a zachovaná pozvánka na Noc básníků.</p><div class="score score-red"><strong>9/9</strong><span>AUTORSKÝ KOMENTÁŘ · DOLOŽENÁ PODÁNÍ · LIDSKÁ KONTROLA</span></div><div class="facts"><p><b>Priorita církevní stránky:</b> řízení Ministerstva kultury pod sp. zn. MK-S 6893/2026 zůstává v živé paměti a nejnovějších listinách.</p><p><b>Nový článek:</b> satirická označení jsou výslovně oddělena od dokumentovaných podání a jejich právního významu.</p></div></div></article>`;
...
const churchEnLead = `<article class="lead-story"><div class="story-image"><img src="assets/votruba/write-lawmakers.jpg" alt="Black-and-white drawing by Jiří Votruba: a hand writing a report"><span>Jiří Votruba</span></div><div class="story-copy"><p class="kicker">STORY OF THE DAY · PASTORAL LETTERS · 15 AUGUST 2026 · REPORT 15082026-012</p><h1><a href="zpravy/15082026-012.html" hreflang="cs">Ten pastoral letters from Europe near Ospělov</a></h1><p class="standfirst">Ten source-linked filings dated 15 August 2026, hearing dates in case 45 T 1/2024 and the preserved invitation to the Night of Poets.</p><div class="score score-red"><strong>9/9</strong><span>AUTHORIAL COMMENTARY · SOURCE-LINKED FILINGS · HUMAN REVIEW</span></div><div class="facts"><p><b>Church priority:</b> the Ministry of Culture proceeding under file MK-S 6893/2026 remains prominent in the live record and latest verified records.</p><p><b>Evidence boundary:</b> satirical labels are expressly separated from the documented filings and any legal conclusion.</p></div></div></article>`;
