...
console.log(`English Godot: ${stateDocuments.length}/67 public records and ${outgoingDocuments.length}/24 translated outgoing filings (${unlinkedOutgoing.length} separately tracked).`);
