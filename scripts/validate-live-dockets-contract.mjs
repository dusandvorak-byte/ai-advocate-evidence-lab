...
if (!englishGodot.includes('data-english-chronology-count="71"') || englishGodotRecords !== 71) {
  throw new Error(`Anglický Godot nemá úplných 71 záznamů: ${englishGodotRecords}`);
}
