...
async function patchEnglishGodotTranslations() {
  ...
  const additions = {
    ...
    'doc-cz-ms-pha-2026-08-25-15-a-44-2026-43': 'The Prague Municipal Court rejected the intervention action against the Ministry of the Interior without examining the merits. It held that the Ministry’s handling of two complaints under Section 175 of the Administrative Procedure Code could not, by its nature, constitute an unlawful intervention under Section 82 of the Code of Administrative Justice. The order states that a cassation complaint may be filed within two weeks of service.',
    'doc-cz-os-pro-2026-08-25-15-nt-3106-2026-predvolani': 'The Prostějov District Court summoned Dušan Dvořák to a public hearing on the application to reopen criminal proceedings, scheduled for 13 October 2026 at 09:00 in courtroom 18, second floor.',
    'doc-cz-os-pro-2026-08-25-15-nt-3106-2026-neslouceni': 'The Prostějov District Court stated that criminal cases 2 T 104/2010 and 2 T 65/2011 had ended at different procedural stages and therefore could not be joined for common proceedings.'
  };
  let changed = 0;
  for (const [id, value] of Object.entries(additions)) {
