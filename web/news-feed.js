...
const cannaNews = [
  {
    ...
    summaryCs: 'Praha označila za příslušné Brno, Brno vrátilo věc Praze a pět listin ze dne 27. července rozšiřuje procesní mapu. Nové veřejné kopie čekají na redakci osobních údajů.',
    summaryEn: 'Prague identified Brno as competent, Brno returned the matter, and five records dated 27 July expand the procedural map. New public copies await personal-data redaction.',
